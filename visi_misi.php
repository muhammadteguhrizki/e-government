...
<html lang="en">
  ...
  <body>
    ...
    <div class="bg-primary text-white" style="min-height: 50px">
      <div class="container">
        <h1 class="text-center lh-base text-truncate">Visi Dan Misi Kecamatan Weleri</h1>
      </div>
    </div>
    <!-- Title akhir -->
    ...
    <div class="container">
      <div class="text" style="font-family: Poppins;">
        <div class="row text-center mt-5">
          <h2>Visi</h2>
          <p>“Terciptanya Pemerintahan Yang Bersih, Amanah, Serta Pelayanan Prima”</p>
          <div class="text-center mt-5">
            <h2>Misi</h2>
            <p>1. Meningkatkan pelayanan kepada masyarakat.</p>
            <p>2. Meningkatkan sumber daya manusia.</p>
            <p>3. Meningkatkan tertib administrasi di segala bidang.</p>
            <p>4. Mendorong partisipasi masyarakat dalam pembangunan.</p>
            <a href="https://www.kendalkab.go.id/instansi/detail/INS0550/kecamatan/weleri" target="_blank"><button type="button" class="btn btn-outline-secondary mb-3">kendalkab.go.id</button></a>
          </div>
        </div>
      </div>
    </div>
