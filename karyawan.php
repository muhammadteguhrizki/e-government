...
<html lang="en">
  ...
  <body>
    ...
    <!-- Title -->
    <div class="title-karyawan bg-primary text-white" style="min-height: 50px">
      <div class="container">
        <h1 class="text-center lh-base text-truncate">Profil Karyawan Kecamatan Weleri</h1>
      </div>
    </div>
    <!-- Title akhir -->
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-primary table-striped text-center" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>Foto</th>
                      <th>Nama</th>
                  ...
                  <tbody>
                   <?php
                    ...
                    $jmlKaryawan = mysqli_num_rows($hasil);
                    if ($jmlKaryawan > 0) {
                      while($row = mysqli_fetch_assoc($hasil)){  
                    ?>
                  <tr>
                    <td><img src="dashboard/karyawan/<?php echo $row['foto']; ?>" style="width: 70px" class="img-thumbnail" /></td>
                    <td><?= $row['nama']; ?></td>
                    <td><?= $row['nip']; ?></td>
                    <td><?= $row['jabatan']; ?></td>
                  </tr>
