        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <img src="karyawan/<?php echo $data['foto']; ?>" class="img-thumbnail" alt="Berita" style="width: 140px;">
                    </div>
                    <div class="row mb-3">
                    ...
                    if(isset($_POST['edit'])) {
                        ...
                        $edit = mysqli_query($koneksi, "UPDATE karyawan SET nama='$nama', nip='$nip', jabatan='$jabatan' WHERE id='$id'");
