        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST" action="tberita.php" enctype="multipart/form-data">
                    <div class="row mb-3">
                        <label for="inputBerita" class="col-sm-2 col-form-label">Judul Berita</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputBerita" name="judul_berita">
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="inputKeterangan" name="isi_berita" rows="3"></textarea>
                        </div>
                    </div>
