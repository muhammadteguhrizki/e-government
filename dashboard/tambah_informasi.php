        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Form Tambah Data Informasi</h1>
                    <form method="POST" action="tinformasi.php" enctype="multipart/form-data">
                    <div class="row mb-3">
                        <label for="inputInformasi" class="col-sm-2 col-form-label">Judul Informasi</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputInformasi" name="judul_informasi">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputHari" class="col-sm-2 col-form-label">Hari</label>
                        <div class="col-sm-10">
                        <select class="form-control" aria-label="Default select example" name="hari" id="inputHari">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <input type="file" class="form-control" id="GetFile" name="foto">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputKeterangan" class="col-sm-2 col-form-label">Keterangan</label>
                        <div class="col-sm-10">
                        <textarea type="text" class="form-control" id="inputKeterangan" name="isi_informasi" rows="3"></textarea>
                        </div>
                    </div>
