        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Ubah Username dan Password</h1>
                    ...
                    <a href="#" type="button" class="btn btn-success" data-toggle="modal" data-target="#saveModal<?php echo $data['id'] ?>">Ubah</a>
                    
                    <!-- modal save -->
                    <div class="modal fade" id="saveModal<?php echo $data['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-body">Klik "Save" jika anda ingin menyimpan perubahan Username & Password.</div>
                    ...
                    if(isset($_POST['ubah'])) {
                        ...
                        $ubah = mysqli_query($koneksi, "UPDATE admin SET username='$username', password='$password' WHERE id='$id'");
