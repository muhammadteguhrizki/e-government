    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                    $id=$_GET['id'];
                    $sql = mysqli_query($koneksi, "SELECT * FROM informasi WHERE id='$id'");
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Form Edit Data Informasi</h1>
                    ...
                    <div class="row mb-3">
                        <label for="inputInformasi" class="col-sm-2 col-form-label">Judul Informasi</label>
                        <div class="col-sm-10">
                        <input type="text" class="form-control" name="judul_informasi" value="<?php echo $data['judul_informasi'];?>">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <select class="form-control" aria-label="Default select example" name="hari">
                            <option selected value="<?php echo $data['hari'];?>"><?php echo $data['hari']; ?></option>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <textarea type="text" class="form-control" name="isi_informasi" rows="3"><?php echo $data['isi_informasi'];?></textarea>
                        </div>
                    </div>
                    <button type="submit" name="edit" class="btn btn-success">Simpan</button>
                    <a href="informasi.php" class="btn btn-danger">Batal</a>
                    </form>
                    ...
                    if(isset($_POST['edit'])) {
                        ...
                        $edit = mysqli_query($koneksi, "UPDATE informasi SET judul_informasi='$judul_informasi', hari='$hari', tanggal='$tanggal', isi_informasi='$isi_informasi' WHERE id='$id'");


                        if($edit){
                            echo"<script>alert('Data Informasi Berhasil Di Edit!');</script>";
