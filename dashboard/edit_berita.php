        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Form Edit Data Berita</h1>
                    ...
                    <div class="row mb-3">
                        <label for="inputBerita" class="col-sm-2 col-form-label">Judul Berita</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                        <textarea type="text" class="form-control" name="isi_berita" rows="3"><?php echo $data['isi_berita'];?></textarea>
                        </div>
                    </div>
                    <button type="submit" name="edit" class="btn btn-success">Simpan</button>
                    <a href="berita.php" class="btn btn-danger">Batal</a>
                    </form>
                    ...
                    if(isset($_POST['edit'])) {
                        ...
                        $edit = mysqli_query($koneksi, "UPDATE berita SET judul_berita='$judul_berita', hari='$hari', tanggal='$tanggal', isi_berita='$isi_berita' WHERE id='$id'");


                        if($edit){
                            echo"<script>alert('Data Berita Berhasil Di Edit!');</script>";
